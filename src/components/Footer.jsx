      ...
      <div className='container'>
        <div className='flex flex-wrap jus text-center lg:text-left'>
          <div className='w-full px-4 mb-12 text-slate-300 font-medium md:w-2/4 '>
            ...
            <p>
              <a href='mailto:chandraperdiansyah@gmail.com'>
                chandraperdiansyah@gmail.com
              </a>
            </p>
            <p>Rempoa, Tangerang Selatan</p>
            <p>Banten</p>
          </div>

          <div className='w-full px-4 mb-10 md:w-1/4 '>
              ...
              {socialLinks.map((data, index) => (
                <li key={index}>
                  <a
                    ...
                    className='mt-2 flex items-center justify-center text-slate-300 border-slate-300  hover:bg-primary hover:text-white lg:justify-start'
                  >
                    <div className='svg flex justify-center items-center w-9 h-9 mr-2'>
                      <svg
                        role='img'
                        viewBox='0 0 24 24'
          ...
          <div className='w-full px-4 mb-10 md:w-1/4'>
            <h3 className='font-semibold text-xl text-white mb-2'>Tautan</h3>
            <ul className='text-slate-300'>
