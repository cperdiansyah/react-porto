...
export default function About(props) {
  ...
  return (
    <section
      className={'about pt-36 pb-32' + className.join(' ')}
      id='tentang-saya'
    >
      <div className='container'>
        <div className='flex flex-wrap'>
          ...
          <div className='w-full px-4 lg:w-1/2'>
            <h3 className='font-semibold text-bold text-2xl mb-4 lg:text-3xl lg:pt-10'>
              Mari Berteman
            </h3>
            ...
            <div className='flex items-center'>
              {/* Instagram */}
              <a
                href='https://www.instagram.com/cperdiansyah'
                target='_blank'
              ...
              {/* Twitter */}
              <a
                href='https://www.twitter.com/cperdiansyaah'
                target='_blank'
                rel='noopener noreferrer'
                className='w-9 h-9 mr-3 rounded-full flex justify-center items-center border text-slate-300 border-slate-300 hover:border-primary hover:bg-primary hover:text-white'
              >
              ...
              {/* Github */}
              <a
                href='https://www.github.com/cperdiansyaah'
                target='_blank'
                rel='noopener noreferrer'
                className='w-9 h-9 mr-3 rounded-full flex justify-center items-center border text-slate-300 border-slate-300 hover:border-primary hover:bg-primary hover:text-white'
              >
